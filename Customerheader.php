...
<br>
<ul>
	 <li>  <?= anchor('CustomerController/index', 'Home', 'title="Home"'); ?></li>
	&nbsp;&nbsp;&nbsp;
  	<li><?= anchor('CustomerController/listProducts', 'List', 'title="List"'); ?></li>
	    &nbsp;&nbsp;&nbsp;
	     <li> <?= anchor('CustomerController/handleInsert', 'Register', 'title="List"'); ?></li>
	    &nbsp;&nbsp;&nbsp;
<li><?= anchor('CustomerDetailController/viewCustomer', 'Customer Details', 'title="Customer Details"'); ?> </li>
